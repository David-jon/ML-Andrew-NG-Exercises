...
%Ordeno las filas en orden ascendente según los datos de la tercera columna
sorted_results = sortrows(results, 3);

%En la primera fila está la C y la sigma del menor error obtenido, los cojo para devolverlos
